    ...
    return (
        <div className="relative w-52 rounded-2xl border border-zinc-700 bg-[#1f1f1f] overflow-hidden shadow-lg">
            ...
            <div className="bg-[#2a2a2a] p-3">
                ...
                <p className="mt-1 text-sm font-medium text-zinc-400">Nike</p>
                ...
                <div className="mt-2 flex items-center gap-1">
                    ...
                    <span className="text-sm text-zinc-400">(128)</span>
                </div>

                {/* Price + Button */}
                <div className="mt-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <span className="text-2xl font-bold text-sky-500">$69</span>
